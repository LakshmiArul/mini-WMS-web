...
function StockTab({ stock, paperForm, setPaperForm, adhesiveForm, setAdhesiveForm, submitPaper, submitAdhesive, busy }) {
  return <>
    <div className="page-intro"><div><p className="eyebrow">Receiving bay</p><h2>Bring raw materials into stock</h2><p className="muted">Record new paper and adhesive lots. Every paper quantity is normalized to kilograms automatically.</p></div><div className="date-chip"><span className="live-dot" />Stock ledger live</div></div>
